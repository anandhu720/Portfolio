...
import memoriesImage from './images/MEMORY.jpg';
...
var cards=[
    ...
    },
    {
        ...
        img:memoriesImage,
        content:"It is bascially a web app which is build using MERN stack.It is a simple cards making and storing website , build while studying how to build MERN websites"
    },

    {
        ...
        img:todoImage,
        content:"It is a basic Node.js build during studying Node.js.It is simple Todo List in which ,you can add , delete the to-do items you want.MongoDB is used to store data."
    },
